	...
	<div id="wrapper2" style="height: 135px">
		...
		<div id="page">
			<div id="content" class="auto-style1" style="height: 623px; width: 819px">
				<div class="welcome">
					<h2 class="title">Rispondi al messaggio</h2>
					<div class="entry" style="height: 239px"> 
						Rispondi alla richiesta<br />
						<br />
						<form method="post" action="ReviewConfirmation.html">
							<textarea name="TextArea1" style="border-style: inset; width: 813px; height: 169px"></textarea>
							<input name="acceptButton" type="submit" value="Invia" class="absolute" style="left: 789px; top: 472px; width: 108px; height: 37px;" />&nbsp;
						</form>
							&nbsp;</div>
				</div>
